    ...
    registration: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            'We have two application deadlines: Priority Deadline was December 6, 2025 (now closed), and Regular Deadline has been extended to February 7, 2026! Decisions will be released on a rolling basis. Don\'t miss this extended opportunity to secure your spot at HackUNCP 2026!',
        },
        {
          id: 'how-to-apply',
